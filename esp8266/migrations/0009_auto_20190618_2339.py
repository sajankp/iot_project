    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appartement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='esp8266.Appartement')),
            ],
            options={
