...
class DataFilterForm(forms.Form):
    ...
    reading = forms.ChoiceField(label="Temperature or Humidity", choices=TYPE_OF_READING, initial="1")
    filter = forms.ChoiceField(label="Time Filter", choices=TYPE_OF_FILTER, initial="mh")
